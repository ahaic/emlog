...
<div id="wrap">
  ...
  <div id="nav">
	...
	<!--  <li class="common"><a href="<?php echo BLOG_URL; ?>admin/">登录</a></li>      注释掉 登陆选项 -->
	
	<?php endif; ?>
   	</ul>
  </div><!-- end #nav-->
  
<!--  height:"134"    "auto"  25 Sept -->  
  <div id="banner"><a href="<?php echo BLOG_URL; ?>"><img src="<?php echo BLOG_URL.Option::get('topimg'); ?>" height="auto" width="960" /></a></div>
